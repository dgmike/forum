...
INSERT INTO `message` (id_message, top_parent_id, parent_id, depth, slug, original_message, message, status)
VALUES (3, 2, 2, 1, '2.1.', 'Vamos!!!', 'Vamos!!!', 'published');

INSERT INTO `message` (id_message, top_parent_id, parent_id, depth, slug, original_message, message, status)
VALUES (4, 2, 2, 1, '2.2.', 'Mas, para qual bar?', 'Mas, para qual bar?', 'published');

INSERT INTO `message` (id_message, top_parent_id, parent_id, depth, slug, original_message, message, status)
VALUES (5, 2, 3, 2, '2.3.1.', 'Tô nessa', 'Tô nessa', 'published');

INSERT INTO `message` (id_message, top_parent_id, parent_id, depth, slug, original_message, message, status)
VALUES (6, 2, 3, 2, '2.3.2.', 'Opa, também vou!', 'Opa, também vou!', 'published');

INSERT INTO `message` (id_message, top_parent_id, parent_id, depth, slug, original_message, message, status)
VALUES (7, 0, 0, 0, '7.', 'Você sabe quem é Mathias?', 'Você sabe quem é Mathias?', 'published');

INSERT INTO `message` (id_message, top_parent_id, parent_id, depth, slug, original_message, message, status)
VALUES (8, 2, 3, 2, '', 'Bando de cachaceiro!!!', 'Bando de cachaceiro!!!', 'deleted');

INSERT INTO `message` (id_message, top_parent_id, parent_id, depth, slug, original_message, message, status)
VALUES (9, 7, 7, 1, '7.1.', 'Num era o cara do Tropa de elite?', 'Num era o cara do Tropa de elite?', 'published');
